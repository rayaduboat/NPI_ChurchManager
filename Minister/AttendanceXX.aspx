            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalMaster">
                        ...
                        <h6>Click on load to load members in Category</h6><hr />
                        <table class="table table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button onclick="new $rab.MasterFilter().LoadOfficers()" id="btnLoadOfficers"  class="mt-2 p-2">Get members in group</button></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4 text-right" ><button onclick="{new  $rab.MasterFilter().GetGroupNames();}"  class="mt-2 p-2">Load group names</button></div>
                                                <div class="col-sm-8 mt-2 p-2"> <select id="selectGetGroupNames" class="form-control"><option>Select group name</option></select></div>
                                    ...
                                    <td><button onclick="new $rab.MasterFilter().LoadGroups(selectGetGroupNames.value)"  id="btnCellGroupMembers"  class="mt-2 p-2">Get members in group</button></td>
