<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Preaching plan.aspx.cs" Inherits="Minister_ManagementList" %>
...
<body>
   <section class="menu cid-qBsAZiDqUG" once="menu" id="menu1-4" data-rv-view="128">
    ...
    <section class="header1 cid-qBsCPrxhwM mbr-parallax-background" id="header1-5" data-rv-view="130" style="height:1000px!important;">


        <div class="container" style="background-color:rgba(18, 2, 2, 0.41)">
            <div class="row justify-content-md-center">
                <div class="mbr-white col-md-10">
                    <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1"> Preaching plan </h1>
