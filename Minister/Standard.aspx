<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Standard.aspx.cs" Inherits="Minister_Events" %>
...
<body>
    <form runat="server">
        ...
        <section style="margin-top: 80px;">
            <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Standard Reports</h2>
            <h3 class="mbr-section-subtitle mbr-fonts-style align-center pb-5 mbr-light display-5">View standard reports 
            </h3>
            <div class="container p-4">
                <div class="row">
                    <div class="col-sm-3">
                        <asp:HiddenField ID="serverBranchName" runat="server" />
                        <select id="selectBranchNames" class="form-control" onchange="{return false;}">
